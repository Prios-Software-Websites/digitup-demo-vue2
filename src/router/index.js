...
const routes = [
  { path: "/", name: "Home", component: MappingTool },
  ...
  {
    path: "/digitallearningdesign",
    name: "DigitalLearningDesign",
    component: DigitalLearningDesign,
  },
  {
    path: "/digitalpedagogicalstrategy",
    name: "DigitalPedagogicalStrategy",
    component: DigitalPedagogicalStrategy,
  },
